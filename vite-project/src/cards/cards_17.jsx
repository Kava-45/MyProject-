...
const Cards_17 = () => {
  ...
  const manufacturers = ["NGN", "KORSON", "BARDAHL", "PEMCO", "GreenCool", "SAMSON"];
  const volumes = ["0,75", "1", "1,5", "10", "2", "20"];
  ...
  const filteredProducts = products.filter((p) => {
    ...
    return matchesSearch && matchesManufacturer && matchesVolume;
  });
